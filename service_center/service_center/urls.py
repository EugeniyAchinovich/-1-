...
urlpatterns = [
    ...
    path('password_change/done/', auth_views.PasswordChangeDoneView.as_view(), name='password_change_done'),  # Успешная смена пароля
    path('', include('service_center_app.urls')),  # Подключение приложения
]